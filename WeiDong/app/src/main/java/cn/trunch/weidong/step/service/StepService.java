...
import cn.trunch.weidong.step.accelerometer.StepCount;
import cn.trunch.weidong.step.accelerometer.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener {
    ...
    private void initNotification() {
        ...
        mBuilder.setContentTitle("微动后台计步中")
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private void updateNotification() {
        ...
        Notification notification = mBuilder.setContentTitle("微动正在运动计步")
