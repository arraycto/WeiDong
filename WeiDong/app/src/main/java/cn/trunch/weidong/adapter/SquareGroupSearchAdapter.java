...
public class SquareGroupSearchAdapter extends RecyclerView.Adapter<SquareGroupSearchAdapter.ViewHolder> {
    ...
    public SquareGroupSearchAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        viewHolder.groupView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TeamEntity group = groups.get(viewHolder.getAdapterPosition() - 1);
